...
@pytest.mark.parametrize(
    "charge, start_dt, end_dt, n_per_hour, effective_start_date, effective_end_date, expected",
    [
...
def test_create_charge_array(
    ...
    ntsteps = int(
        (end_dt - start_dt) / np.timedelta64(15, "m")
    )
    datetime = pd.DataFrame(
        np.array(
            [
                start_dt + np.timedelta64(i * 15, "m")
    ...
    result = costs.create_charge_array(charge, datetime, effective_start_date, effective_end_date)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"electric": np.arange(96), "gas": np.arange(96)},
            {
                "electric_demand_peak-summer_2024-03-09_2024-03-09_0": {"demand": 0, "cost": 0}, 
                "electric_demand_half-peak-summer_2024-03-09_2024-03-09_0": {"demand": 0, "cost": 0}, 
                "electric_demand_off-peak_2024-03-09_2024-03-09_0": {"demand": 0, "cost": 0}, 
                "electric_demand_half-peak-winter1_2024-03-09_2024-03-09_0": {"demand": 0, "cost": 0}, 
                "electric_demand_half-peak-winter2_2024-03-09_2024-03-09_0": {"demand": 0, "cost": 0},
            },
            0,
            np.float64(2023.5)            
        ),
        (
            ...
            {"electric": np.arange(96), "gas": np.arange(96)},
            {
                "electric_demand_peak-summer_2024-07-10_2024-07-10_0": {"demand": 7.078810759792355, "cost": 150}, 
                "electric_demand_half-peak-summer_2024-07-10_2024-07-10_0": {"demand": 13.605442176870748, "cost": 80}, 
                "electric_demand_off-peak_2024-07-10_2024-07-10_0": {"demand": 42.253521126760563, "cost": 900}, 
                "electric_demand_half-peak-winter1_2024-07-10_2024-07-10_0": {"demand": 0, "cost": 0}, 
                "electric_demand_half-peak-winter2_2024-07-10_2024-07-10_0": {"demand": 0, "cost": 0},
            },
            0,
            np.float64(2897.79)
        ),    
